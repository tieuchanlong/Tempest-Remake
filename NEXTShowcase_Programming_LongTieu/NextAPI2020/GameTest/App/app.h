...
namespace App
{
	...
	// Draw Squares
	//**
	void DrawSquare(float center_x, float center_y, float size, float r = 1.0f, float g = 1.0f, float b = 1.0f);

	//**
	// Draw Triangle
	//**
	void DrawTriangle(float center_x, float center_y, float size, float r = 1.0f, float g = 1.0f, float b = 1.0f);
